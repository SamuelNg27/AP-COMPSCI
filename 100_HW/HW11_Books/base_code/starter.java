...
class starter {
        ...
        */
        while(true){
            ...
            if(choice.equals("printNum")){
                ...
                printsNumber(arr, num_word);
                sc.nextLine(); 
            }
            if(choice.equals("change")){
                System.out.println("What file do you want to change to?");
                String new_arr = sc.nextLine();
                arr = fillArray(new_arr);
            }
    ...
    */
    public static int checksArray(String[] arr, String check){
        ...
        System.out.println("The word \"" + check + "\" appears " + counter + " times.");
        return counter;
    }
    ...
    */
    public static String mostCommon(String[] arr){
        ...
        System.out.println("The most common word is: " + Dupe);
        return Dupe;
    }
